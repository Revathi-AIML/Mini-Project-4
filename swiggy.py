...
cleaned_df = pd.read_csv(f"E:/vscode/swiggy/evn/Scripts/cleaned_csv.csv")

# Load encoders, scaler, and model
with open(f'E:/vscode/swiggy/evn/Scripts/encoder.pkl', 'rb') as f:
    encoders = pickle.load(f)

with open(f'E:/vscode/swiggy/evn/Scripts/ekmeans_model.pkl', 'rb') as f:
    kmeans = pickle.load(f)

image_url = f"E:/vscode/swiggy/evn/Scripts/Swiggy_logo.png"
